            ...
            <div className="  py-8 ">
                <div className="w-full  font-serif max-w-md p-6 text-black m-auto mx-auto bg-gray-300 rounded-2xl shadow-md dark:bg-gray-800">
                    ...
                    <form onSubmit={handleSignIn}>
                        ...
                        <div className="mt-6">
                            <button className="relative w-full inline-flex hover:text-white items-center justify-center border-2 px-6 py-3 overflow-hidden font-bold text-black rounded-md shadow-2xl group">
                    ...
                    <button onClick={handleGoogleLogin} className="relative w-full inline-flex items-center justify-center border-2 px-6 py-3 hover:text-white overflow-hidden font-bold text-black rounded-md shadow-2xl group">
                        <span className="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-0 bg-gradient-to-br from-gray-500 via-[#1B1616] to-gray-500 group-hover:opacity-100"></span>
                        <span className="absolute top-0 left-0 w-full bg-gradient-to-b from-white to-transparent opacity-5 h-1/3"></span>
                        <span className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-white to-transparent opacity-5"></span>
                        <span className="absolute bottom-0 left-0 w-4 h-full bg-gradient-to-r from-white to-transparent opacity-5"></span>
